...
import {
    makeNodeVisible,
    convertHaff2VerticalIndex,
    convertVerticalIndex2YOffset
} from '../../actions/componentTreeActions'


class Inflater extends Component {
            ...
            root.map((component, i) => {
                ...
                switch (component.name) {
                            ...
                            <TextInputWrapper index={i} key={i} clicked={clicked}
                                ...
                                onClick={() => {
                                    if (clicked != true) {
                                        ...
                                        //将对应的当前组件结点滚动至组件树中间
                                        var scrollTop = convertVerticalIndex2YOffset(convertHaff2VerticalIndex(this.props.components, prefix))
                                        this.props.dispatch(makeComponentTreeScroll(scrollTop - 715 / 2))
                                        this.props.dispatch(setComponentSelected(prefix))
                                    }
                    ...
                    case ItemTypes.LISTVIEW:
                        ...
                        arr.push(
                            <ListView index={i} key={i} styleMap={styleMap} clicked={clicked} attributes={attributes} 
                                haff={prefix}
...
export default connect(mapStateToProps)(Inflater);
