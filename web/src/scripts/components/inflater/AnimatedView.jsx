...
class AnimatedView extends Component {
    ...
    render() {
        ...
        var { styleMap, device, connectDropTarget, isOver } = this.props
        //do filering
        ...
        return (
            ...
            connectDropTarget(<div className={'AnimatedView ' + className}
                style={style}
                onClick={(event) => {
                    this.props.onClick();
...
export default connect(mapStateToProps)(AnimatedView);
