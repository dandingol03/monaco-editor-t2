...
const rowSource = {
    beginDrag(props) {
        return {
            index: props.index,
            type: ItemTypes.COMPONENT_SCROLLVIEW,
            haff: props.haff,
            id: props.index !== undefined && props.index !== null ? 'component-scrollview-' + props.index : undefined,
        };
    }
};
...
@DragSource(ItemTypes.COMPONENT_SCROLLVIEW, rowSource, (connect, monitor) => ({
...
class ComponentListView extends Component {
    ...
    render() {
        ...
        var className='Component-ScrollView'
        if(props.selected)
        {
            className+=' clicked'
        ...
        return (
            ...
            connectDragSource(
                <div id={'component-scrollview-' + props.index} className={className} style={defaultStyle} >
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginRight: 5, marginLeft: 5 }}>
                            <span className='icon-scrollview'></span>
                        </div>
