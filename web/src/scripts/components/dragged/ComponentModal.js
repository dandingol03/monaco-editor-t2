...
const rowSource = {
    beginDrag(props) {
        return {
            index: props.index,
            type: ItemTypes.COMPONENT_MODAL,
            haff: props.haff,
...
@DragSource(ItemTypes.COMPONENT_MODAL, rowSource, (connect, monitor) => ({
...
class ComponentModal extends Component {
    ...
    render() {
        ...
        return (
            ...
            connectDragSource(
                <div id={'component-modal-' + props.index} className={className} style={defaultStyle} >
...
export default connect()(ComponentModal);
