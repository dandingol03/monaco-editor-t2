...
const dragSource = {
    beginDrag(props) {
        return {
            type: ItemTypes.TouchableOpacity,
...
class TouchableOpacity extends Component {
    ...
    render() {
        ...
        var className = 'Code-template TouchableOpacity'
                    ...
                    <div style={{ flexDirection: 'column', display: 'flex',flex:'1 1 auto' }}>
                        <div style={{ flexDirection: 'row', display: 'flex' }}>
                            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginRight: 5, marginLeft: 5 }}>
                                <span className='icon-touchable-opacity'></span>
                            </div>
...
export default connect()(TouchableOpacity);
