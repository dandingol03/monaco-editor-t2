...
import NpmLoginModalButton from './NpmLoginModalButton'
...
class ToolbarButton extends Component {
    ...
    _buildButtonStyle(width) {
        ...
        {
            buttonStyle=_.extend({},buttonStyle,this.props.buttonStyle)
        }
    ...
    render() {
        ...
        var vectorIcon=this.props.vectorIcon;
        ...
        >
          ...
          <div style={buttonStyle}>
            {
                vectorIcon!==undefined&&vectorIcon!==null?
                    <span style={{fontSize:vectorIcon.size+'px',color:vectorIcon.color}}><i className={'fa fa-'+vectorIcon.name}></i></span>:
                    <div style={iconStyle} />
            }
          </div>
        </div>
